...
n.mif_length      <- 3000
n.mif_particles   <- 1200
n.mif_rw.sd       <- 0.02
focal.county      <- "South Florida"  ## County to fit to
...
param_array <- array(
  data = 0
, dim  = c(nparams, n.mif_runs, 14))
dimnames(param_array)[[3]] <- c("beta0", "alpha", "alpha1", "soc_dist_level_sip", "loglik", "E_init", "Ia_init", "Ip_init", "Is_init", "Im_init", "Hr_init", "Hd_init", "R0_init", "D0_init")  
} else {
param_array <- array(
  data = 0
, dim  = c(nparams, n.mif_runs, 14))
...
param_array <- array(
  data = 0
, dim  = c(nparams, n.mif_runs, 13))  
dimnames(param_array)[[3]] <- c("beta0", "alpha", "alpha1", "loglik", "E_init", "Ia_init", "Ip_init", "Is_init", "Im_init", "Hr_init", "Hd_init", "R0_init", "D0_init")  
} else {
param_array <- array(
  data = 0
, dim  = c(nparams, n.mif_runs, 13))  
...
, intervention     = c(
  ...
  rep(0, sim_length)#  rep(0, int_start1 - sim_start)                   
...
library(dplyr)
  ...
  , {
    if (fit_to_sip) {
      if (fit.E0) {
    c(beta0              = rlnorm(1, log(0.2), 0.17)
    , alpha             = rlnorm(1, log(0.05), 0.2)
    , alpha1             = rlnorm(1, log(0.2), 0.2)
  ...
  , rw.sd  = {
    if (fit_to_sip) {
      if (fit.E0) {
    rw.sd(beta0 = n.mif_rw.sd, alpha = n.mif_rw.sd, alpha1 = n.mif_rw.sd, soc_dist_level_sip = n.mif_rw.sd, E_init = n.mif_rw.sd, Ia_init = n.mif_rw.sd, Ip_init = n.mif_rw.sd, Is_init = n.mif_rw.sd, Im_init = n.mif_rw.sd, Hr_init = n.mif_rw.sd, Hd_init = n.mif_rw.sd, R0_init = n.mif_rw.sd, D0_init = n.mif_rw.sd)        
      } else {
    rw.sd(beta0 = n.mif_rw.sd, alpha = n.mif_rw.sd, alpha1 = n.mif_rw.sd, soc_dist_level_sip = n.mif_rw.sd, E_init = n.mif_rw.sd, Ia_init = n.mif_rw.sd, Ip_init = n.mif_rw.sd, Is_init = n.mif_rw.sd, Im_init = n.mif_rw.sd, Hr_init = n.mif_rw.sd, Hd_init = n.mif_rw.sd, R0_init = n.mif_rw.sd, D0_init = n.mif_rw.sd)        
      }
    } else {
      if (fit.E0) {
    rw.sd(beta0 = n.mif_rw.sd, alpha = n.mif_rw.sd, alpha1 = n.mif_rw.sd, E_init = n.mif_rw.sd, Ia_init = n.mif_rw.sd, Ip_init = n.mif_rw.sd, Is_init = n.mif_rw.sd, Im_init = n.mif_rw.sd, Hr_init = n.mif_rw.sd, Hd_init = n.mif_rw.sd, R0_init = n.mif_rw.sd, D0_init = n.mif_rw.sd)        
      } else {
    rw.sd(beta0 = n.mif_rw.sd, alpha = n.mif_rw.sd, alpha1 = n.mif_rw.sd, E_init = n.mif_rw.sd, Ia_init = n.mif_rw.sd, Ip_init = n.mif_rw.sd, Is_init = n.mif_rw.sd, Im_init = n.mif_rw.sd, Hr_init = n.mif_rw.sd, Hd_init = n.mif_rw.sd, R0_init = n.mif_rw.sd, D0_init = n.mif_rw.sd)        
      }
    }
