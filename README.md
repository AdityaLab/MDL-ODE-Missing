...
Run the MDLINFER.sh to run the code.

We also provide a demo code to quickly run the MDL algorithms. Here, we save the step 1 calibration results for different reported rate alpha. The demo code usually take 1-2 hours to run.
