...
dmeas_deaths <- Csnippet("double tol = 1e-16;
                   ...
                   if (ISNA(cases)) {
                       ...
                       if (D_new_reported < 1250) {                         
                           lik = lik + 0.001*dpois(cases, D_new_reported + tol, 1);
                       }
                       else {
                           lik = lik - 10000000;
                       }
                   ...
                   if (ISNA(uncases)) {
                       ...
                       if (D_new_unreported < 125000) {                         
                           lik = lik + 0.0001*dpois(uncases, D_new_unreported + tol, 1);
                       }
                       else {
                           lik = lik - 10000000;
                       }
