...
if __name__ == "__main__":
  ...
  def MDL_alpha(alpha, ParameterP):
    ...
    while(True):
      try:
        ...
        DataCost = TimeSeriesCost((((ReportedPP+UnreportedPP)-Reported[1:21])/(1.0-ReportRate))-(ReportedPP+UnreportedPP))
  ...
  MDL_alpha(0.36, ParameterP)
  MDL_alpha(0.37, ParameterP)
  MDL_alpha(0.38, ParameterP)
  MDL_alpha(0.39, ParameterP)
  MDL_alpha(0.40, ParameterP)
  MDL_alpha(0.41, ParameterP)
  MDL_alpha(0.42, ParameterP)
  MDL_alpha(0.43, ParameterP)
  MDL_alpha(0.44, ParameterP)
  MDL_alpha(0.45, ParameterP)
  MDL_alpha(0.46, ParameterP)
  MDL_alpha(0.47, ParameterP)
  MDL_alpha(0.48, ParameterP)
  MDL_alpha(0.49, ParameterP)
  MDL_alpha(0.50, ParameterP)
  MDL_alpha(0.51, ParameterP)
  MDL_alpha(0.52, ParameterP)
  MDL_alpha(0.53, ParameterP)
  MDL_alpha(0.54, ParameterP)
  MDL_alpha(0.55, ParameterP)
  MDL_alpha(0.56, ParameterP)
  MDL_alpha(0.57, ParameterP)
  MDL_alpha(0.58, ParameterP)
  MDL_alpha(0.59, ParameterP)
  MDL_alpha(0.60, ParameterP)
  MDL_alpha(0.61, ParameterP)
  MDL_alpha(0.62, ParameterP)
  MDL_alpha(0.63, ParameterP)
  MDL_alpha(0.64, ParameterP)
  MDL_alpha(0.65, ParameterP)
  MDL_alpha(0.70, ParameterP)
  MDL_alpha(0.75, ParameterP)