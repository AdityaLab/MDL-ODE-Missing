...
if __name__ == "__main__":
  ...
  DataSelected = DataFile[(DataFile["sim_start"] == "2020-05-24")]
  ...
  def MDL(D, ParameterP, warm=False):
    ...
    while(True):
      try:
        ...
        ModelCost3 = TimeSeriesCost(ReportRate*D[1:21] - ReportedP)
        DataCost = TimeSeriesCost(((D[1:21]-Reported[1:21])/(1.0-ReportRate))-(ReportedPP+UnreportedPP))
