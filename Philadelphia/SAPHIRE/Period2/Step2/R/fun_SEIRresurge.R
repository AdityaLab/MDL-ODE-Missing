...
SEIRresurge <- function(pars, init_settings, lift_type = 1, zero_days = 14, outbreak_sign = 100, return.Mat = F) {
  ...
  stage_end <- c(300)                # corresponding to dates Jan9, Jan22, Feb1, Feb16, the last day (we set it as the the epidemic will end if continue the surveillance and interventions )
  ##
