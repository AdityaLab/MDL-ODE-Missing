  ...
  def MDL(D, ParameterP, warm=False):
    ...
    while(True):
      try:
        ...
        ModelCost3 = TimeSeriesCost(ReportRate*D[1:17] - ReportedP)
        DataCost = TimeSeriesCost(((D[1:17]-Reported[1:17])/(1.0-ReportRate))-(ReportedPP+UnreportedPP))
