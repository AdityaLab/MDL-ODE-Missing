...
if __name__ == "__main__":
  ...
  DataSelected = DataFile[(DataFile["sim_start"] == "2020-10-10")]
  ...
  res = minimize(fun=MDL_step2, x0=D_start, args=(D_start,ParameterP), method='nelder-mead', options={'maxiter':1, 'xtol':1000, 'ftol':100})
