  ...
  def MDL_alpha(alpha, ParameterP):
    ...
    while(True):
      try:
        ...
        DataCost = TimeSeriesCost((((ReportedPP+UnreportedPP)-Reported[1:41])/(1.0-ReportRate))-(ReportedPP+UnreportedPP))
