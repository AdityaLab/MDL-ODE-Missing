...
if __name__ == "__main__":
  ...
  def MDL_alpha(alpha, ParameterP):
    ...
    DataCost = TimeSeriesCost((((ReportedPP+UnreportedPP)-Reported[1:36])/(1.0-ReportRate))-(ReportedPP+UnreportedPP))
