...
if __name__ == "__main__":
    ...
    ax.set_title("Minneapolis (SEIR+HD)", fontsize=15)
    ...
    ax.scatter(X[31:],SymptomRate[31:],label=r'\textsc{Rate}'+r'$_{\mathrm{Symp}}$',marker='+',s=25,color='#000000')
    ax.fill_between(X[31:],(SymptomRate[31:]-SymptomError[31:]),(SymptomRate[31:]+SymptomError[31:]),color='#000000',alpha=0.25)
    ...
    ax.set_title("South Florida (SEIR+HD)", fontsize=15)
    ...
    ax.set_xticklabels(XDate)
    ax.xaxis.set_tick_params(labelsize=12)
    ax.set_yticks([0,0.5,1.0,1.5,2,2.5,3])
    ax.set_yticklabels(["0","0.005","0.01","0.015","0.02","0.025","0.03"])
    ax.yaxis.set_tick_params(labelsize=12)
    ax.set_ylim(0,3)
